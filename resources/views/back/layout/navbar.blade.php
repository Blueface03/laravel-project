                    ...
                    <ul class="dropdown__menu">
                        @php
                            $programs = [
                                ...
                                'TAHUN ANGGARAN' => [
                                    ['title' => 'Tahun Anggaran 2021', 'url' => url('/anggaran2023/1')],
                                    ['title' => 'Tahun Anggaran 2022', 'url' => url('/anggaran2023/2')],
                                    ['title' => 'Tahun Anggaran 2023', 'url' => url('/anggaran2023/1')],
                                    ['title' => 'Tahun Anggaran 2024', 'url' => url('/anggaran2023/2')],
                                    ['title' => 'Tahun Anggaran 2025', 'url' => url('/anggaran2023/1')],
                                ],
                            ];
                        @endphp
