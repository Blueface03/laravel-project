    ...
    <section class="document-section2">
        ...
        <div class="document-item2">
            ...
            <div class="button-group2">
                <a href="{{ route('download.pdf', ['filename' =>  $filename]) }}" class="btn-custom btn-custom-download-1"><i class="fas fa-download"></i> Download</a>
                <a href="{{ asset('back/assets/pdf/' . $filename) }}" target="_blank" class="btn-custom btn-custom-read-2"><i class="fas fa-book-open"></i> Lihat</a>
